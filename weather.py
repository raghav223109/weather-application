...
weather_icon.place(x=550, y=150)  
...
def getweather():
    try:
        ...
        #weather
        api="http://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=7761cc06ab266bab50056f499660989b"

        json_data = requests.get(api).json()
        condition = json_data['weather'][0]['main']
        description = json_data['weather'][0]['description']
        temp = int(json_data['main']['temp']-273.15)
        perssure = json_data['main']['pressure']
